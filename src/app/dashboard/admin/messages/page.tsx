...
import { adminGetBrandThreads } from '@/lib/actions/admin-messages'
import { AdminMessagesClient } from '@/components/dashboard/AdminMessagesClient'
...
export default async function AdminMessagesPage() {
  ...
  const threads = await adminGetBrandThreads()
