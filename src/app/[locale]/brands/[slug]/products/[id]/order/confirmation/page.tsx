    ...
    <div className="min-h-screen flex flex-col" style={{ background: '#F5F0E8' }}>
      ...
      <main className="flex-1 flex items-center justify-center px-6">
        <div className="max-w-sm w-full py-16">
          ...
          <p className="text-base text-center leading-relaxed mb-10" style={{ color: '#6B5B4E' }}>
            {isAr
          ...
          <div className="flex flex-col gap-3">
            ...
            <Button
              ...
              variant="secondary"
              fullWidth
              className="hover:border-[#B8975A] hover:text-[#B8975A]"
              style={{ borderColor: '#E5DDD0', color: '#6B5B4E', fontFamily: 'var(--font-body)' }}
            >
              {isAr ? 'تتبع طلبك' : 'Track your order'}
            </Button>
            <Button href="/" variant="back" fullWidth className="border-0" style={{ color: '#6B5B4E' }}>
              {isAr ? 'الرئيسية' : 'Home'}
            </Button>
          </div>
