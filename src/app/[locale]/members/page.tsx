    ...
    <section className="relative min-h-screen overflow-hidden flex items-center">
      ...
      <div className="relative z-20 w-full px-6 md:px-10 lg:px-20 xl:px-28 flex items-center min-h-screen">
        <div className="max-w-xl lg:max-w-2xl">
          ...
          <p className="mt-5 md:mt-7 text-base md:text-base font-light max-w-xs md:max-w-sm leading-relaxed" style={{ color: 'rgba(255,255,255,0.65)' }}>
            {t('subheading')}
          </p>

          <div className="mt-10 md:mt-12 flex flex-col sm:flex-row gap-3">
            <Button href="/apply/member" variant="primary" className="bg-gold text-ink hover:bg-gold-light" style={{ fontFamily: 'var(--font-body)' }}>
              {t('enquire_cta')}
            </Button>
            <Button href="#membership" variant="secondary" className="border-parchment/30 text-parchment hover:border-gold hover:text-gold" style={{ fontFamily: 'var(--font-body)' }}>
              Learn more
            </Button>
          </div>
    ...
    <section id="membership" className="px-6 md:px-10 py-20 md:py-28 border-b border-border">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex items-end justify-between mb-12 md:mb-16">
          <div>
            <p className="text-[12px] text-gold tracking-[0.4em] uppercase mb-4">Membership</p>
          ...
          {MEMBER_TYPES.map((type) => (
            ...
            >
              <div className="flex items-start justify-between">
                <span className="text-[12px] text-gold/60 tracking-[0.3em] uppercase">{type.index}</span>
        ...
        <div className="grid md:grid-cols-[1fr_1fr] gap-16 md:gap-24 items-start">
          ...
          <div>
            <div className="flex items-center gap-4 mb-8">
              ...
              <p className="text-[12px] text-gold/60 tracking-[0.35em] uppercase">Founding members</p>
            </div>
          ...
          <div className="grid grid-cols-2 gap-3">
            {(['Creator', 'Athlete', 'Club', 'Media'] as const).map((label, i) => (
              <div key={i} className="border border-border/40 aspect-[3/4] flex flex-col justify-between p-4 opacity-25">
                ...
                <p className="text-[12px] tracking-[0.25em] uppercase text-muted">{label}</p>
              </div>
            ))}
          </div>
